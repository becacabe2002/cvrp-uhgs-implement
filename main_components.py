...
def initializepop(p):
    ...
    grantTour = list(range(1, p.n))
    args = []
    for _ in range(togenerate):
        args.append([grantTour, p])
...
def crossover(possol, negsol, p):
    ...
    while parent1 == parent2:
        ...
        if pick1.fitness > pick2.fitness:
            ...
            parent2 = pick2
    print("parent1: ", parent1.cost, parent1.feas, # parent, cost, feasibility
          "\nparent2:", parent2.cost, parent2.feas)
    sonGT = OXcrossover(parent1, parent2, p)
